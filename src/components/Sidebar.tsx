      ...
      <Disclosure className='' as="nav">
        {({ open }) => (
          <>
            ...
            <div
              className={`p-6 w-1/2 h-screen z-20 fixed top-0 ${
                isSidebarOpen
                  ? "left-0 peer-focus:left-0 peer:transition lg:transparent  dark:bg-slate-900 bg-gray-200 bg-opacity-95 ease-out delay-150 duration-200 w-60 lg:w-60 md:w-60  lg:left-0"
              ...
              <div className="flex flex-col justify-start items-center">
                ...
                <div className="my-4  border-gray-100 pb-4">
                   <Link href='/dashboard'>
                     <div className="flex mb-2 justify-start items-center gap-4 pl-5  p-2 rounded-md group cursor-pointer hover:text-gray-500  m-auto ">
                           ...
                           <h3 className="text-base light:text-gray-800 pt-1  font-semibold">Dashboard</h3>
                     </div>
                   </Link>
                   <Link href='/Leads'>
                     <div className="flex mb-2 justify-start items-center gap-4 pl-5  p-2 rounded-md group cursor-pointer hover:text-gray-500  m-auto ">
                           <CgProfile className='text-2xl light:text-gray-900 group:hover:text-white'/>
                           <h3 className="text-base light:text-gray-800 pt-1  font-semibold">Profile</h3>
                     </div>
                   </Link>
                   <Link href='/notes'>
                     <div className="flex mb-2 justify-start items-center gap-4 pl-5  p-2 rounded-md group cursor-pointer hover:text-gray-500  m-auto ">
                           <FaRegComments className='text-2xl light:text-gray-900 group:hover:text-white'/>
                           <h3 className="text-base light:text-gray-800 pt-1  font-semibold">Notes</h3>
                     </div>
                   </Link>
                   <Link href='/analytics'>
                     <div className="flex mb-2 justify-start items-center gap-4 pl-5  p-2 rounded-md group cursor-pointer hover:text-gray-500  m-auto ">
                           <MdOutlineAnalytics className='text-2xl light:text-gray-900 group:hover:text-white'/>
                           <h3 className="text-base light:text-gray-800 pt-1  font-semibold">Analytics</h3>
                     </div>
                   </Link>
                   <div className="flex mb-2 justify-start items-center gap-4 pl-5  p-2 rounded-md group cursor-pointer hover:text-gray-500  m-auto ">
                ...
                <div className="my-4 -ml-[40px]  border-gray-100 pb-4">
                   ...
                   <div className="flex mb-2 justify-start items-center gap-4 pl-5  p-2 rounded-md group cursor-pointer hover:text-gray-500  m-auto ">
                         ...
                         <h3 className="text-base light:text-gray-800 pt-1  font-semibold">Settings</h3>
                   </div>
                   <div className="flex mb-2 justify-start items-center gap-4 pl-5  p-2 rounded-md group cursor-pointer hover:text-gray-500  m-auto ">
                         < MdOutlineMoreHoriz className='text-2xl light:text-gray-900 group:hover:text-white'/>
                         <h3 className="text-base light:text-gray-800 pt-1  font-semibold">Help</h3>
                   </div>
                   </div>
                   <div className="my-4 -ml-[40px]    border-gray-100 pb-4">
                   ...
                   <button onClick={()=>{
                    signOut().catch(console.error)
                         ...
                         <h3 className="text-base light:text-gray-800 pt-1  font-semibold">Logout</h3>
                   </button>
                   </div>
              </div>
